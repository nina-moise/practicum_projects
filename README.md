...
| 3. | [TargetFeed A/B](https://github.com/nina-moise/practicum_projects/tree/main/TargetFeed%20A-B%20test)  |Дизайн и подведение итогов A/B эксперимента для внедрения новой "фичи" в приложении с функцией «бесконечной» ленты|python, pandas, matplotlib, matplotlib_venn, scipy, proportions_ztest, NormalIndPower| 
