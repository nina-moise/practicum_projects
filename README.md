...
| 3. | [TargetFeed A/B]()  |Дизайн и подведение итогов A/B эксперимента для внедрения новой "фичи" в приложении с функцией «бесконечной» ленты|python, pandas, matplotlib, matplotlib_venn, scipy, proportions_ztest, NormalIndPower| 
